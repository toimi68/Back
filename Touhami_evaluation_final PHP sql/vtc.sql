...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 28 mai 2019 à 17:05
...
--
ALTER TABLE `association_vehicule_conducteur`
  MODIFY `id_association` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `conducteur`
--
ALTER TABLE `conducteur`
  MODIFY `id_conducteur` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
